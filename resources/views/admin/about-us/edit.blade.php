		...
		<div class="col-lg-12">
			<div class="card dz-card">
				...
				<div class="card-body pt-0">
					<div class="p-4">
						<form class="row g-3" method="POST" action="{{route('admin.about.us.update', $aboutUs->id)}}" enctype="multipart/form-data">
							@csrf
							@method("PATCH")
							<div class="col-md-4">
								<label for="name" class="form-label">Judul</label>
								<input type="text" class="form-control" id="name" name="name" value="{{$aboutUs->name}}">
							</div>
							<div class="col-md-4">
								<label for="email" class="form-label">Email</label>
								<input type="email" class="form-control" id="email" name="email" value="{{$aboutUs->email}}">
							</div>
							<div class="col-md-4">
							...
							<div class="col-md-6">
								...
								<textarea  class="form-control" id="address" name="address">{{$aboutUs->address}}</textarea>
							</div>
							<div class="col-md-6">
