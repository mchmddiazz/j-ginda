...
<div class="deznav">
	<div class="deznav-scroll">
		<ul class="metismenu" id="menu">
			...
			@can(PermissionEnum::USERS_INDEX())
				<li>
					<a href="{{ route('admin.offline.store.create') }}"
					   class="{{ request()->is(route('admin.offline.store.create')) ? 'active' : '' }}"
					   aria-expanded="false">
						<div class="menu-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
								 xmlns="http://www.w3.org/2000/svg">
						...
						<span class="nav-text">Offline Store</span>
					</a>
				</li>
			@endcan
			...
			@canany([PermissionEnum::ADMIN_ORDERS_INDEX(), PermissionEnum::ADMIN_ORDER_TRANSACTIONS()])
				{{-- TRANSAKSI --}}
				<li>
					<a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
						<div class="menu-icon">
...
{{--			@can(PermissionEnum::ADMIN_FINANCE_TRANSACTION_REPORTS())--}}
{{--				<li>--}}
...
{{--			@endcan--}}
						...
						@can(PermissionEnum::REPORT_ORDERS())
							<li>
								<a href="{{ route('admin.reports.show.order') }}"
								   class="{{ request()->is(route('admin.reports.show.order')) ? 'active' : '' }}"
								   aria-expanded="false">
									<div class="menu-icon">
										<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
										     xmlns="http://www.w3.org/2000/svg">
			...
			@can(PermissionEnum::REPORT_PRODUCTS())
				<li>
					<a href="{{ route('admin.reports.show.product') }}"
					   class="{{ request()->is(route('admin.reports.show.product')) ? 'active' : '' }}"
					   aria-expanded="false">
						<div class="menu-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
								 xmlns="http://www.w3.org/2000/svg">
						...
						<span class="nav-text">Laporan Barang</span>
					</a>
				</li>
			@endcan

			@can(PermissionEnum::REPORT_REQUEST_PRODUCTION())
				<li>
					<a href="{{ route('admin.reports.show.request.production') }}"
					   class="{{ request()->is(route('admin.reports.show.request.production')) ? 'active' : '' }}"
					   aria-expanded="false">
						<div class="menu-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none"
								 xmlns="http://www.w3.org/2000/svg">
