                    ...
                    <div class="axil-checkout-billing">
                        ...
                        <div class="a1">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="address1" name="address" class="mb--15" value="{{ $user->address }}"
                    ...
                    <div class="axil-order-summery order-checkout-summery">
                        ...
                        <div class="order-payment-method">
                            ...
                            <hr style="border: 1px solid;">
                                ...
                                <p>Setelah mengeklik “Checkout”, Anda akan diarahkan ke Payments via Midtrans untuk menyelesaikan proses pembayaran secara aman.</p>
                            </div>
                        </div>
